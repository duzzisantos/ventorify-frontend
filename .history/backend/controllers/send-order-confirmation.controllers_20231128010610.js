...
exports.sendOrderConfirmation = async (req, res) => {
  ...
  const savedPdf = fs.writeFileSync(`${req.body.customerName}.pdf`, pdfBuffer);
  ...
  const handleEmailSend = async () => {
    ...
    let email = await emailTransporter.sendMail({
      ...
      text: `Dear ${mailRecipient}, here is your order. Please proceed to pay and we can
        complete the ordering process. Thank you. Your Ventorify Team.`,
      attachments: [
        {
