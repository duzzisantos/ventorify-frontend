...
const StaffPerformance = ({ staffName, element }) => {
  ...
  return (
    <Card className="col-md-9 col-lg-6">
      ...
      <Card.Body>
        ...
        <div className="d-flex gap-2">
          <div className="d-flex flex-column flex-nowrap gap-2 col-12">
            <div className="rounded-2 text-center p-2 border border-secondary d-flex flex-column col-5">
              <small className="fw-bold">Total Goods Stowed</small>
              {getStowingAmount}
            </div>
            <div className="rounded-2 text-center p-2 border border-secondary d-flex flex-column col-4">
