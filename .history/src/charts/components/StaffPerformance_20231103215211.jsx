...
const StaffPerformance = ({ staffName, element }) => {
  ...
  return (
    <Card className="col-md-5 col-lg-5">
      ...
      <Card.Body>
        ...
        <div className="d-flex gap-2">
          <div className="d-flex gap-2 col-12 mt-4">
            <div className="rounded-2 text-center p-2 shadow-sm border d-flex flex-column col-6">
              <small className="fw-bold text-success">Total Goods Stowed</small>
              <small className="text-success fw-bold">{getStowingAmount}</small>
            </div>
            <div className="rounded-2 text-center p-2 shadow-sm d-flex flex-column col-6">
              <small className="fw-bold text-success">Top Product</small>
