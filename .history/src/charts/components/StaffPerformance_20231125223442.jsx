...
const StaffPerformance = ({ staffName, element }) => {
  ...
  return (
    <Card className="col-md-5 col-lg-5 shadow-sm border-0">
      <Card.Header className="bg-transparent fw-bold text-dark">
        {staffName}
      </Card.Header>
      <Card.Body>
        <div className="d-flex hstack">
          <Form.Label htmlFor="select year">Year</Form.Label>
          <Form.Select
            id="select year"
            value={selectedYear}
          ...
          <Form.Label htmlFor="select month">Month</Form.Label>
          <Form.Select
            id="select month"
            value={selectedMonth}
        ...
        <div className="d-flex gap-2">
          <div className="d-flex gap-2 col-12 mt-4">
            <div className="rounded-2 text-center p-2 shadow-sm d-flex flex-column col-6">
              <small>Total Goods Stowed</small>
              <small className="text-success">{getStowingAmount ?? 0}</small>
            </div>
            <div className="rounded-2 text-center p-2 shadow-sm d-flex flex-column col-6">
