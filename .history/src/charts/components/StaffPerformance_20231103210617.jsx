...
const StaffPerformance = ({ staffName, element }) => {
  ...
  console.log(getTopStowedProducts());
        ...
        <div className="d-flex gap-2">
          <div className="d-flex flex-column flex-nowrap w-50 gap-2">
            <div className="rounded-2 text-center p-2 border border-secondary d-flex flex-column">
              <small className="fw-bold">Total Amount Stowed</small>
              {getStowingAmount}
            </div>
            <div className="rounded-2 text-center p-2 border border-secondary d-flex flex-column">
              <small className="fw-bold">Top Stowed Products</small>
              {getTopStowedProducts()}
            </div>
          </div>
