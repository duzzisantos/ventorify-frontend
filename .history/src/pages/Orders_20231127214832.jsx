...
const Orders = () => {
  ...
  const commonClasses =
    "fw-bold col-lg-2 border border-secondary rounded-2 justify-content-center align-items-center d-block py-4 col-md-4";
  return (
    <Container className="col-md-10 text-secondary text-start major-wrapper">
      ...
      <div className="col-md-10 my-4 mx-3 mb-5">
        <div className="col-12 my-3 d-flex gap-4">
          <div className={commonClasses}>Paid</div>
