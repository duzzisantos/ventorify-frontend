...
const EmployeePerformance = () => {
  ...
  return (
    <Container className="text-start text-secondary py-5 px-1 vh-100 vw-100">
      ...
      <section className="col-md-10 my-4 mx-3 mb-5 vw-100">
        <h2 className="fs-6 fw-bold">Start Viewing Employees</h2>
        <div className="d-flex flex-row vw-q00">
