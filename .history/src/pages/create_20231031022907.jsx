...
const CreateRecord = () => {
  ...
  const renderProductPrice = () => {
    productPrices.filter((item) =>
      item.product.includes(record.product) ? item.unitPrice : !item.unitPrice
    );
  };
        ...
        <div className="mx-3 mb-5 col-md-6 text-start">
          <form onSubmit={handlePost} encType="multipart/form-data">
            ...
            <div className="mb-3">
              ...
              {filteredOutRecords && (
                <Alert>
                  Predefined price for {filteredOutRecords} is{" "}
                  {renderProductPrice()}
                </Alert>
              )}
            </div>
            ...
            <div className="mb-3">
              ...
              {filteredOutRecords && (
                <Alert className="alert-info text-dark mt-3 text-end px-2 rounded-2">
