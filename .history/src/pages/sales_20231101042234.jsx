...
const Sales = () => {
  ...
  return (
    <Container className="col-md-10 major-wrapper mb-5 pb-5">
      <div className="my-5 text-start mx-3 text-secondary">
        <h1 className="fw-bold">Sales</h1>
        <p>View sales performance over time.</p>
      </div>
      <div className="row cols col my-4 mx-3 d-flex flex-row flex-wrap hstack gap-3">
        <div className="col-md-6 p-3 table-border shadow-sm">
