...
const ShoppingBasket = ({
  ...
  console.log(filteredOrdersByDate);
  ...
  return (
    <Card className="col-lg-12 col-sm-12" bg="transparent">
      ...
      <Card.Body className="d-flex flex-column">
        <p className="shadow-sm border-start border-5 border-info-subtle p-3">
          <b>Instructions</b>: After filling the customer form and fulfilling
          sales, click on <kbd className="bg-secondary">Generate Order</kbd>,
          then filter by date and optionally{" "}
          <kbd className="bg-light border-1 text-dark">Generate PDF</kbd> or go
          ahead to <kbd className="bg-success">Confirm Order</kbd>
        </p>
