    ...
    <Card className="col-lg-12 col-sm-12" bg="transparent">
      ...
      <Card.Body className="d-flex flex-column">
        <p className="shadow-sm border-start border-5 border-info-subtle p-3">
          <b>Instructions</b>: After filling the customer and sales forms, click
          on <kbd className="bg-secondary">Generate Order</kbd>, then filter by
          date and optionally{" "}
          <kbd className="bg-light border text-dark">Generate PDF</kbd>
        </p>
