...
const ShoppingBasket = ({
  ...
  //   axios
  //     .get(`http://localhost:4000/api/sales?customerId=${customerId}`, {
  //       headers: {
  //         Accept: "application/json",
  //       },
  //       responseType: "blob",
  ...
  const blob = new Blob([filteredOrdersByDate], { type: "application/text" });
        ...
        <div className="vstack gap-2">
          ...
          <section className="my-3 p-3 shadow-sm bg-white py-3 rounded-2">
            ...
            {generateOrder && customerId && customerName && (
              <a href={url} download={`${customerName}-order.pdf`}>
