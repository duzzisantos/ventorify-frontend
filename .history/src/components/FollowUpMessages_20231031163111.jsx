...
const FollowUpMessages = ({ emailhasReply, id, data }) => {
  return (
    <>
      {emailhasReply && (
        <div className="col-md-10 col-10 p-3 mt-5 mb-3 border-end border-secondary border-5 shadow-lg">
          ...
          {data
            ...
            .map((item, index) => (
              <div
                key={index}
                className="d-flex flex-column hstack gap-3 justify-content-start"
              >
