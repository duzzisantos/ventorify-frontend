...
import { sendConfirmation } from "../api-calls/useSendConfirmation";
...
const ShoppingBasket = ({
  ...
  const [orderAsPDF, setOrderAsPDF] = useState(null);
        ...
        <div className="vstack gap-2">
          ...
          <section>
            ...
            <SendOrderConfirmation
              customerName={customerName}
              customerId={customerId}
              orderAsPDF={orderAsPDF}
              setCustomerId={setCustomerId}
              setCustomerName={setCustomerName}
              setOrderAsPDF={setOrderAsPDF}
              handleSubmit={sendConfirmation}
            />
          </section>
        </div>
      </Card.Body>
