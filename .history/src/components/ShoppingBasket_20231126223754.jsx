      ...
      <Card.Body className="d-flex flex-column">
        <div className="vstack gap-2">
          ...
          <section className="my-3 p-3 shadow-sm bg-white py-3 rounded-2">
            ...
            <Button onClick={generateOrderSummary}>Generate Order</Button>
            ...
            {generateOrder && customerId && customerName && (
              <div className="d-flex hstack gap-3 justify-content-between">
                <Form.Label htmlFor="selectedDate" className="fw-bold w-25">
                  Select Date
                </Form.Label>
                <Form.Control
                  type="date"
                ...
                />
                <Button
                  className="border border-secondary bg-transparent text-dark w-25 p-1"
